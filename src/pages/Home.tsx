    ...
    <div className="flex flex-col w-full min-h-screen px-4">
      ...
      <div className="flex flex-wrap justify-center gap-2 mb-16">
        {items.map((item, index) => (
          <span
            key={index}
            className="flex items-center gap-2 border border-gray-300 px-3 py-1.5 text-sm text-gray-700 hover:border-blue-400 hover:text-blue-600 transition-colors cursor-pointer"
          >
            {item.icon} {item.label}
          </span>
        ))}
